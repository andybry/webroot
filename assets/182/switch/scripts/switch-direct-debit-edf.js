...
var switchApplication = {
	...
	previousAddressController:function(addressNumber) {
		...
		var addressFieldset = '<fieldset id="address-'+addressNumber+'">\n\
			...
			\t\t\t<input id="previousAddress1.town" name="previousAddress'+addressNumber+'.town" class="text" type="text" value="" maxlength="30"/>\n\
			\t\t</div>\n\
			\t\t<div class="field-wrapper">\n\
...
var customValidation = {
	setMandatory: function (obj) {
		obj.parent().find('span.mandatory').html('*');
		return true;
	},
	
	setOptional: function (obj) {
		customValidation.removeErrorMsg(obj);
		obj.parent().find('span.mandatory').html('');
		return true;
	},
...
$(document).ready(function () {
    var validator = $("#registrationForm").validate({
        rules: {
            ...
            "dobMonth": "required",
            "dobYear": "required", 
            "daytimePhoneNumber": {required: true, number: true},
            "eveningPhoneNumber": { 
                required: {
            ...
            "mobilePhoneNumber": {
            	required: function(element) {
            		customValidation.removeErrorMsg($(element));
            		return customValidation.selectedListValue("preferredReadReminderMethod") === "SMS";
            	},
            	number: true
            },
            "emailAddressType": {required: {depends: function(element){return $(element).is(':visible')}}},
            "emailAddress": {
            	required: function(element) {
            		customValidation.removeErrorMsg($(element));
            		return customValidation.selectedListValue("preferredReadReminderMethod") === 'Email' || customValidation.selectedListValue("preferredBillCommunicationMethod") === 'Email';
            	},
            	email: true
            },
            "confirmEmailAddress": {
            ...
            "supplyAddress.addressLine1": {required: {depends: function(element){return $(element).is(':visible')}}}, "supplyAddress.town": {required: {depends: function(element){return $(element).is(':visible')}}}, "supplyAddress.postcode": {required: {depends: function(element){return $(element).is(':visible')}}}, 
            "previousAddress1.addressLine1": {required: {depends: function(element){return $(element).is(':visible')}}}, "previousAddress1.town": {required: {depends: function(element){return $(element).is(':visible')}}}, "previousAddress1.postcode": {required: {depends: function(element){return $(element).is(':visible')}}},
            "previousAddress2.addressLine1": {required: {depends: function(element){return $(element).is(':visible')}}}, "previousAddress2.town": {required: {depends: function(element){return $(element).is(':visible')}}}, "previousAddress2.postcode": {required: {depends: function(element){return $(element).is(':visible')}}},
            "contactAddress.addressLine1": {required: {depends: function(element){return $(element).is(':visible')}}}, "contactAddress.town": {required: {depends: function(element){return $(element).is(':visible')}}},
            "contactAddress.postcode": {required: {depends: function(element){return $(element).is(':visible')}}},
            "preferredReadReminderMethod": {required: {depends: function(element){
            	return $(element).is(':visible')}}
            },
            "preferredBillCommunicationMethod": {required: {depends: function(element){
            	return $(element).is(':visible')}}
            },
            "preferredCommunicationFormat": {required: {depends: function(element){return $(element).is(':visible')}}},
            "supplyAddress.yearsAtAddress": {required: {depends: function(element){return $(element).is(':visible')}}}, "supplyAddress.monthsAtAddress": {required: {depends: function(element){return $(element).is(':visible')}}},
            "previousAddress2.yearsAtAddress": {required: {depends: function(element){return $(element).is(':visible')}}}, "previousAddress1.monthsAtAddress": {required: {depends: function(element){return $(element).is(':visible')}}},
            "previousAddress2.yearsAtAddress": {required: {depends: function(element){return $(element).is(':visible')}}}, "previousAddress2.monthsAtAddress": {required: {depends: function(element){return $(element).is(':visible')}}},
            "directDebitAccountHoldersName": {required: {depends: function(element){return $(element).is(':visible')}}}, "directDebitAccountNumber": {required: {depends: function(element){return $(element).is(':visible')}}, number: true}, "sortCode1": {required: {depends: function(element){return $(element).is(':visible')}}, number: true}, "sortCode2": {required: {depends: function(element){return $(element).is(':visible')}}, number: true}, "sortCode3": {required: {depends: function(element){return $(element).is(':visible')}}, number: true}, "directDebitDate": {required: {depends: function(element){return $(element).is(':visible')}}}, 
            "onlineMothersName": {required: {depends: function(element){return $(element).is(':visible')}}}, "onlinePassword": {required: {depends: function(element){return $(element).is(':visible')}}}, "confirmOnlinePassword": {required: {depends: function(element){return $(element).is(':visible')}}, equalTo: "#onlinePassword"}, "loyaltyCardNumber": {number: true},
            "employmentStatus": {required: {depends: function(element){return $(element).is(':visible')}}}, "residentialStatus": {required: {depends: function(element){return $(element).is(':visible')}}},
            "acceptedTermsAndConditions": "required", "acceptedTermsAndConditionsSwitch": {required: {depends: function(element){return $(element).is(':visible')}}},
        ...
        messages: {
            ...
            "dobDay": {required: "Please select a date of birth"},
            "dobMonth": {required: "Please select a date of birth"},
            "dobYear": {required: "Please select a date of birth"},
            "daytimePhoneNumber": {required: "Please enter a telephone number", number: "Please enter a valid telephone number"},
            "eveningPhoneNumber": {required: "Please enter a home telephone number", number: "Please enter a valid home telephone number"},
            "mobilePhoneNumber": {required: "Please enter a mobile phone number", number: "Please enter a valid mobile phone number"},
            "emailAddressType": {required: "Please select your email address type"},
            "emailAddress": {required: "Please enter your email address", email: "Please enter a valid email address"},
            "confirmEmailAddress": {required: "Please re-enter your email address", email: true, equalTo: "This email address does not match that given above"},
            "telephoneNumberType": {required: "Please select a telephone number type"},
            "supplyAddress.addressLine1": {required: "Please enter address line 1"} , "supplyAddress.town": {required: "Please enter a town/city"}, "supplyAddress.postcode": {required: "Please enter a UK postcode"},
            ...
            "contactAddress.addressLine1": {required: "Please enter correspondence address line 1"},
            "contactAddress.town": {required: "Please enter a correspondence town/city"}, "contactAddress.postcode": {required: "Please enter a correspondence UK postcode"},
            "preferredReadReminderMethod": {required: "Please select a preferred reminder method"},
            "preferredBillCommunicationMethod": {required: "Please select a preferred communication method"},
            "preferredBillCommunicationFormat": {required: "Please select a preferred communication format"},
    ...
    $("#qasId").change(function(){
        ...
        //If there is an ajax call, cancel it
	...
	// Attach listener to drop-down to detect user changing selection of reminder fields
	// If selection === Email make email field mandatory
	// If selection === SMS make mobile phone number mandatory
	$('#mobilePhoneNumber').parent().find('label').append('<span class="mandatory"></span>')
	$('#preferredReadReminderMethod, #preferredBillCommunicationMethod').change(function () {
		var doc = document,
			fieldChanges = {
				'': [
					'#mobilePhoneNumber, #emailAddress, #confirmEmailAddress',
					false
				],
				'Email': [
					'#mobilePhoneNumber',
			...
			id1 = 'preferredReadReminderMethod',
			id2 = 'preferredBillCommunicationMethod',
			field1 = doc.getElementById(id1),
			field2 = doc.getElementById(id2),
			choice = field1.options[field1.selectedIndex].value + field2.options[field2.selectedIndex].value,
			optionalFields = fieldChanges[choice][0],
			mandatoryFields = fieldChanges[choice][1];
		if (optionalFields !== false) {
			customValidation.setOptional($(optionalFields));
		}
		if (mandatoryFields !== false) {
			customValidation.setMandatory($(mandatoryFields));
		}
	}).change();
...
$(document).ready(function() {   
	ddInfoPopup();
	// temporary fix for urgent update https://whichonline.onjira.com/browse/WSONE-279 
	$("#loyaltyCardType").parent().css("display", "none");
	$("#loyaltyCardNumber").parent().css("display", "none");
	// FAQ Link

...
$(document).ready(function (){
    var validator = $("#registrationForm").validate({
        rules: {
            ...
            "contactAddress.addressLine1": {required: {depends: function(element){return $(element).is(':visible')}}}, "contactAddress.town": {required: {depends: function(element){return $(element).is(':visible')}}}, "contactAddress.postcode": {required: {depends: function(element){return $(element).is(':visible')}}},
            "preferredCommunicationMethod": {required: {depends: function(element){return $(element).is(':visible')}}}, "preferredCommunicationFormat": {required: {depends: function(element){return $(element).is(':visible')}}},
            ...
            "onlineMothersName": {required: {depends: function(element){return $(element).is(':visible')}}}, "onlinePassword": {required: {depends: function(element){return $(element).is(':visible')}}}, "confirmOnlinePassword": {required: {depends: function(element){return $(element).is(':visible')}}, equalTo: "#onlinePassword"}, "loyaltyCardNumber": {required: {depends: function(element){return $(element).is(':visible')}}, number: true},
        ...
        messages: {
            ...
            "contactAddress.addressLine1": {required: "Please enter correspondence address line 1"}, "contactAddress.town": {required: "Please enter a correspondence town/city"}, "contactAddress.postcode": {required: "Please enter a correspondence UK postcode"},

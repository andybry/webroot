                ...
                switch (action) {
                    case 'playing':
                        if (val1 !== undefined && val2 !== undefined) {
                            window._gaq.push(['whichGAP._trackEvent', 'Video', 'Playing - ' + val1 + '% ', video, parseInt(val2, 10)]);
                        } else {
                            window._gaq.push(['whichGAP._trackEvent', 'Video', 'Playing - ' + val1 + '% ', video]);
                        }
                        break;
                    case 'error':
                        window._gaq.push(['whichGAP._trackEvent', 'Video', 'Error - ' + val1, video]);
                        break;
                    default:
                    if (val1 !== undefined) {
                        window._gaq.push(['whichGAP._trackEvent', 'Video', action, video, parseInt(val1, 10)]);
                    } else {
                        window._gaq.push(['whichGAP._trackEvent', 'Video', action, video]);
                    }
                }
             };
